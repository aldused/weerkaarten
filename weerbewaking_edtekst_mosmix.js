...
(function(root){
  ...
  const api={station,directions,weekdays,fullDays,localDate,addDays,beaufort,mapFeed,selectDays};if(typeof module!=='undefined')module.exports=api;else root.MOSMIX=api;
})(globalThis);
