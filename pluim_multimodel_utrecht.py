...
header_ax.text(0.012,0.22, info, fontsize=8,color="#94a3b8",va="center",transform=header_ax.transAxes)
header_ax.text(0.988,0.65,"Multi-model pluim – Utrecht",
          fontsize=15,color="white",weight="bold",
          ha="right",va="center",transform=header_ax.transAxes)
header_ax.text(0.988,0.22,f"{runtime}  ·  {now_str}",fontsize=8,color="#94a3b8",
          ha="right",va="center",transform=header_ax.transAxes)
