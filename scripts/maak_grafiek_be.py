...
ax_h.text(0.012, 0.25, "MOS ECMWF/ICON", fontsize=7.5, color="#94a3b8", va="center", transform=ax_h.transAxes)
...
ax_h.text(0.988, 0.25, f"DWD MOSMIX  ·  run: {now_str}", fontsize=7, color="#94a3b8", ha="right", va="center", transform=ax_h.transAxes)
