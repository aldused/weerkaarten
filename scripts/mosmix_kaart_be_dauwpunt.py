...
for day, dag_data in data_per_day.items():
    ...
    ax_h.text(0.012,0.22,"Dauwpunt min 00-12u  .  MOS ECMWF/ICON",fontsize=8,color="#94a3b8",va="center",transform=ax_h.transAxes)
    ...
    ax_h.text(0.988,0.20,f"DWD MOSMIX  .  run: {now_str}",fontsize=8,color="#94a3b8",ha="right",va="center",transform=ax_h.transAxes)
