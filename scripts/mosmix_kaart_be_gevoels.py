...
for day, dag_data in data_per_day.items():
    ...
    ax_h.text(0.012,0.22,"Gevoelstemperatuur  ·  MOS ECMWF/ICON",fontsize=8,color="#94a3b8",va="center",transform=ax_h.transAxes)
    ...
    ax_h.text(0.988,0.20,f"Vet = max 06-18u  ·  cursief = min 00-12u  ·  DWD MOSMIX run: {now_str}",
              fontsize=7.5,color="#94a3b8",ha="right",va="center",transform=ax_h.transAxes)
