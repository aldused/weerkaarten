...
- `/ens6-runs?latitude=…&longitude=…` leest het complete publicatiemanifest (39 stations, 51 leden). De opties zijn de gepubliceerde bruikbare runs, nieuwste eerst, met volledige UTC-datum. De catalogus is gekoppeld aan de locatie. Een nieuwe live run die nog niet in het archief staat (of een vrije locatie) wordt pas toegevoegd na een kleine beschikbaarheidscontrole van twee tijdstippen en alle 51 kernveldleden, met metadata vóór/na de controle; hierbij wordt geen volledige niet-geselecteerde verwachting geladen.
