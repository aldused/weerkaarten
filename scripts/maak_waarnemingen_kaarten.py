...
# ── Kleurenschalen ────────────────────────────────────────────────────────────
cmap_tx   = mcolors.LinearSegmentedColormap.from_list("tx",   ["#084594","#1565c0","#64b5f6","#a5d6a7","#2e8b57","#388e3c","#43a047","#66bb6a","#8bc34a","#aed581","#cddc39","#e6ee3b","#ffeb3b","#fdd835","#fbc02d","#f9a825","#f57f17","#ef6c00","#e65100","#d84315","#b71c1c","#880e4f","#4a148c"])
