...
EXTENT = [3.0, 7.5, 50.4, 53.9]
DPI = 150
FIG_W, FIG_H = 8, 7  # inches → 1200×1050 px bij 150 dpi
...
def maak_kaart(fname, modus="bg"):
    ...
    if modus == "bg":
        ...
        ax.add_feature(cfeature.RIVERS.with_scale("10m"),
                        edgecolor="#89b8d4", linewidth=0.5, zorder=3)
        ax.add_feature(cfeature.COASTLINE.with_scale("10m"),
                        edgecolor="#333333", linewidth=0.8, zorder=4)
        ax.add_feature(cfeature.BORDERS.with_scale("10m"),
                        edgecolor="#666666", linewidth=0.7, linestyle="--", zorder=4)
...
if __name__ == "__main__":
    print("Radar basiskaart genereren...")
