...
BRON="/Users/aldus/KNMI_Project/weerlab"
DOEL="/Users/aldus/KNMI_Project/weerlab backup $(date '+%Y-%m-%d')"
...
ls -dt "/Users/aldus/KNMI_Project/weerlab backup "* 2>/dev/null | tail -n +5 | while read oud; do
