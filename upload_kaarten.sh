...
# Waarnemingen en toplijst draaien nu dynamisch waar mogelijk; satelliet blijft PNG.
...
"$SCRIPT_DIR/shell/git_publish.sh" \
    ...
    toplijst.json toplijst.html index.json p13_records.html p13_records.js \
