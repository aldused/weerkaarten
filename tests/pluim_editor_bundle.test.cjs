...
for (const page of [
  ...
  assert.match(fs.readFileSync(path.join(root, page), 'utf8'), page==='pluim_6_plus.html' ? /pluim_ens6_runs\.browser\.js/ : /pluim_run_switcher_48ffbf926db6\.js/, `${page}: directe gezamenlijke 00\/06\/12\/18-runkeuze ontbreekt`);
}
