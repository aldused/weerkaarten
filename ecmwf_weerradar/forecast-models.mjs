...
export const MODEL_CONFIG={
 ...
 harmonie:{label:'HARMONIE 43 Benelux',detail:'HARMONIE 43 · regionaal',region:'Benelux · circa 60 uur',attribution:'KNMI / Weerlab',
  type:'regional',projection:'Regelmatig lat/lon 0,029°×0,018° (KNMI P1-GRIB, niet uitgedund)',nativeResolutionKm:2.5,extent:[0.522,49,11.281,56.002],
  ...
  resolution:'Volle HARMONIE-modelresolutie, circa 2,5 km (sinds 23-09-2026 ook voor temperatuur, wind, zicht en bewolking).'},
