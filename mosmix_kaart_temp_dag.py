...
print("MOSMIX ophalen (max dagtemperatuur TX)...")
...
for code, name in stations:
    ...
    for i, dt in enumerate(times):
        ...
        d = loc.date()
        # TX is een periodewaarde die DWD rapporteert vanaf 12:00u lokaal
        # (etmaal 06-18u; waarde is beschikbaar bij tijdstippen >= 12:00u)
...
for day, dag_data in data_per_day.items():
    ...
    maak_header(fig, gs, dag_nl, day, now_str, "Max temperatuur dag (06–18u)  \u00b7  MOS ECMWF/ICON")
