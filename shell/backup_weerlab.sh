...
# overgenomen. Hier houd je vijf momentopnamen waar je op terug kunt vallen.
#
...
#
# .git gaat mee (18 GB): daarmee is elk herstelpunt op zichzelf compleet en ben
# je niet afhankelijk van GitHub. Alleen logs en Python-cache blijven buiten de
# backup — die zijn wegwerpbaar.
#
