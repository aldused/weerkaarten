...
window.WEERLAB_MENU_SITE = {
  ...
  categories:{
    ...
    analyse:{name:'Analyse',icon:'chart',title:'Verdieping bij de verwachting',description:'Vergelijk de verwachting per plaats en lees de meteorologische modelbeoordeling.'},
  ...
  browse:[
    ...
    {id:'analyse',description:'Hoe ontwikkelt de verwachting zich?',links:[['trend','Trend per plaats'],['guidance','Guidance modelbeoordeling']]}
  ]
};
const MENU_LABELS = {};
const MENU_PRODUCTS = [
  ...
  {id:'trend',name:'MOS/MIX trend',description:'Temperatuur, neerslag en wind per Belgische plaats voor de komende tien dagen.',category:'analyse',type:'analyse',icon:'pluimtrend',src:'grafiek_trend_be.html',thumbnail:'thumbs/mosmix-trend.webp',keywords:'België Belgisch MOSMIX DWD tien dagen plaatsen vergelijken grafiek temperatuur neerslag regen wind bewolking'},
