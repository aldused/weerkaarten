"""
haal_waarschuwingen.py — DEPRECATED

Gebruik scrape_waarschuwingen.py. Dit script schrijft een oud JSON-formaat
(provincies/bijgewerkt) dat niet compatibel is met waarschuwingen.html.
upload_kaarten.sh en run_waarschuwingen.sh draaien scrape_waarschuwingen.py.
"""
import sys
print("FOUT: haal_waarschuwingen.py is deprecated. Gebruik scrape_waarschuwingen.py.", file=sys.stderr)
sys.exit(1)
